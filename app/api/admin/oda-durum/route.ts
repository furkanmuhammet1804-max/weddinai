// Yönetici oda durumunu değiştirir: aktif/pasif yapma + süre uzatma.
//   islem: "aktif" | "pasif" | "uzat"
//   gun:   "uzat" için eklenecek gün (varsayılan 7)
...
export async function POST(request: Request) {
  ...
  if (islem === "uzat") {
    const gun = Number.isFinite(body.gun) && body.gun ? Math.min(365, Math.max(1, Math.floor(body.gun!))) : 7;
    // Mevcut süreyi (veya şimdiyi) baz alıp uzat.
